...
Например, для исходного числа 12 = 11002 результатом является число 1111112 = 63, а для исходного числа 05 = 1012 – это число 100102 = 18.
...
print(f"проверка корректности работы: 12 = {funk(12)}, 05 = {funk(5)}")
