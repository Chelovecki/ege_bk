...
"""
# РУЧНОЕ РЕШЕНИЕ, но я показал это кодом
...
# ПРОГРАММНОЕ РЕШЕНИЕ
# кстати, на экзе я думал правильно, но сделал дичь
print("------------------------")
...
for mask in range(33):
    ...
    if net1 == net2:
        this_mask = net2.netmask
        print(sum([int(bait) for bait in str(this_mask).split('.')]))
